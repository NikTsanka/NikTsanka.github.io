...
(function () {
    ...
    const T = {
        ka: {
            ...
            'nav.dd.electric': 'ელექტრომონტაჟი', 'nav.dd.fire': 'სახანძრო უსაფრთხოება', 'nav.dd.alarm': 'ვიდეომეთვალყურეობა',
            'nav.products': 'პროდუქცია', 'nav.contact': 'კონტაქტი',
            // FOOTER
            'footer.tagline': 'დანადგარების მონტაჟი',
            'footer.brand.p': 'პროფესიული ელექტრომონტაჟი, სახანძრო უსაფრთხოება და ვიდეომეთვალყურეობის სისტემები მთელ საქართველოში.',
            ...
            'footer.link.electric': '► ელექტრომონტაჟი', 'footer.link.fire': '► სახანძრო სისტემა', 'footer.link.alarm': '► ვიდეომეთვალყურეობა',
            'footer.copy': '© 2026 DM Energy — დანადგარების მონტაჟი. ყველა უფლება დაცულია.',
            ...
            'bc.alarm': 'ვიდეომეთვალყურეობა', 'bc.contact': 'კონტაქტი', 'bc.products': 'პროდუქცია',
            // SHARED
            'shared.gallery.tag': 'გალერეა', 'shared.gallery.h2': 'შესრულებული სამუშაოები',
            'shared.process.tag': 'სამუშაო პროცესი',
            'shared.cta.btn.contact': 'დაგვიკავშირდით', 'shared.cta.btn.phone': '+995 599 658 935',
            // INDEX
            ...
            'idx.hero.p': 'DM Energy გთავაზობთ სრულ სპექტრს — ელექტრო ინსტალაციიდან სახანძრო სიგნალიზაციამდე. ხარისხი, სწრაფობა, სანდოობა.',
            ...
            'idx.svc4.title': 'ვიდეომეთვალყურეობა', 'idx.svc4.desc': 'IP კამერების დაყენება, ციფრული ვიდეო ჩამწერი სისტემები, ღრუბლოვანი მონიტორინგი და დისტანციური წვდომა.', 'idx.svc4.link': 'დაწვრილებით →',
            'idx.why.tag': 'რატომ ჩვენ?', 'idx.why.h2': 'რატომ უნდა აირჩიოთ DM Energy?',
            ...
            // ALARM
            'alarm.banner.h2': 'ვიდეომეთვალყურეობა და დაცვის სისტემები', 'alarm.bc': 'ვიდეომეთვალყურეობა',
            'alarm.process.h2': 'ვიდეომეთვალყურეობის მონტაჟი',
            ...
            'alarm.gallery.p': 'ვიდეომეთვალყურეობისა და დაცვის სისტემების რეალური პროექტები',
            'alarm.cta.h2': 'დაიცავით თქვენი ქონება', 'alarm.cta.p': 'თანამედროვე ვიდეომეთვალყურეობა — 24/7 დაცვა ნებისმიერი ადგილიდან',
            // CONTACT
            ...
            'contact.form.err': '✗ გაგზავნა ვერ მოხდა. სცადეთ ხელახლა ან დაგვიძახეთ: +995 599 658 935',
        ...
        en: {
            ...
            'nav.dd.electric': 'Electrical Installation', 'nav.dd.fire': 'Fire Safety', 'nav.dd.alarm': 'Video Surveillance',
            'nav.products': 'Products', 'nav.contact': 'Contact',
            'footer.tagline': 'Equipment Installation',
            'footer.brand.p': 'Professional electrical installation, fire safety and video surveillance systems throughout Georgia.',
            ...
            'footer.link.electric': '► Electrical Installation', 'footer.link.fire': '► Fire Safety', 'footer.link.alarm': '► Video Surveillance',
            'footer.copy': '© 2026 DM Energy. All rights reserved.',
            ...
            'bc.alarm': 'Video Surveillance', 'bc.contact': 'Contact', 'bc.products': 'Products',
            'shared.gallery.tag': 'Gallery', 'shared.gallery.h2': 'Completed Projects',
            'shared.process.tag': 'Work Process',
            'shared.cta.btn.contact': 'Contact Us', 'shared.cta.btn.phone': '+995 599 658 935',
            ...
            'idx.hero.p': 'DM Energy offers a full range of services — from electrical installation to fire alarm systems. Quality, speed, reliability.',
            ...
            'idx.why.tag': 'Why Us?', 'idx.why.h2': 'Why Choose DM Energy?',
            ...
            'alarm.banner.h2': 'Video Surveillance & Security', 'alarm.bc': 'Video Surveillance',
            'alarm.process.h2': 'Video Surveillance Installation',
            ...
            'alarm.gallery.p': 'Real video surveillance and security projects',
            'alarm.cta.h2': 'Protect Your Property', 'alarm.cta.p': 'Modern video surveillance — 24/7 protection from anywhere',
            ...
            'contact.form.err': '✗ Failed to send. Please try again or call: +995 599 658 935',
        ...
        ru: {
            ...
            'nav.dd.electric': 'Электромонтаж', 'nav.dd.fire': 'Пожарная безопасность', 'nav.dd.alarm': 'Видеонаблюдение',
            'nav.products': 'Продукция', 'nav.contact': 'Контакт',
            'footer.tagline': 'Монтаж оборудования',
            'footer.brand.p': 'Профессиональный электромонтаж, пожарная безопасность и системы видеонаблюдения по всей Грузии.',
            ...
            'footer.link.electric': '► Электромонтаж', 'footer.link.fire': '► Пожарная система', 'footer.link.alarm': '► Видеонаблюдение',
            'footer.copy': '© 2026 DM Energy. Все права защищены.',
            ...
            'bc.alarm': 'Видеонаблюдение', 'bc.contact': 'Контакт', 'bc.products': 'Продукция',
            'shared.gallery.tag': 'Галерея', 'shared.gallery.h2': 'Выполненные работы',
            'shared.process.tag': 'Рабочий процесс',
            'shared.cta.btn.contact': 'Связаться с нами', 'shared.cta.btn.phone': '+995 599 658 935',
            ...
            'idx.hero.p': 'DM Energy предлагает полный спектр услуг — от электромонтажа до пожарной сигнализации. Качество, скорость, надёжность.',
            ...
            'idx.why.tag': 'Почему мы?', 'idx.why.h2': 'Почему выбирают DM Energy?',
            ...
            'alarm.banner.h2': 'Видеонаблюдение и системы охраны', 'alarm.bc': 'Видеонаблюдение',
            'alarm.process.h2': 'Монтаж видеонаблюдения',
            ...
            'alarm.gallery.p': 'Реальные проекты видеонаблюдения и систем охраны',
            'alarm.cta.h2': 'Защитите вашу собственность', 'alarm.cta.p': 'Современное видеонаблюдение — защита 24/7 из любого места',
            ...
            'contact.form.err': '✗ Не удалось отправить. Попробуйте ещё раз или позвоните: +995 599 658 935',
